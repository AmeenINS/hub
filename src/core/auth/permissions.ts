import { PermissionService, RolePermissionService } from '@/core/data/user-service';
import { hasPermission, isSuperAdmin, mapPermissionsByModule } from '@/core/security/permission-utils';
import type { Permission } from '@/shared/types/database';
