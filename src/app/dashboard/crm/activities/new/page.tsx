    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">{t('crm.activities.createNew')}</h1>
            <p className="text-muted-foreground">{t('crm.activities.createNewDescription')}</p>
          </div>
        </div>
      </div>
