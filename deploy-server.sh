...
start() {
    ...
    print_info "Application will be available at: https://ameenhub.sbc.om"
...
deploy() {
    ...
    print_info "Domain: ameenhub.sbc.om → Your Server IP"
    echo ""
